    ...
    <div id="sidebar" class="sidebar">
      ...
      <ul class="list">
        ...
        <li class="list__item list__item--click">
          ...
          <ul class="list__show">
            <li class="list__inside">
              <a href="#" class="nav__link nav__link--inside">Ropa y Accesorios</a>
            </li>

            <li class="list__inside">
              <a href="#" class="nav__link nav__link--inside">Herramientas</a>
            </li>
        ...
        <li class="list__item list__item--click">
          ...
          <ul class="list__show">
            <li class="list__inside">
              <a href="#" class="nav__link nav__link--inside">De Ventas</a>
            </li>
        ...
        <li class="list__item list__item--click">
          <div class="list_button list_button--click">
            ...
            <a href="#" class="nav__link">Ayuda y configuración</a>
            <img class="list_arrow" src="img/nav/sidebar/arrow.png" alt="arrow">
          </div>

          <ul class="list__show">
            <li class="list__inside">
              <a href="#" class="nav__link nav__link--inside">Servicio al cliente</a>
            </li>

            <li class="list__inside">
              <a href="#" class="nav__link nav__link--inside">Tu cuenta</a>
            </li>
